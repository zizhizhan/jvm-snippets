...
public class TryInvokeDynamic {
    ...
    public static CallSite bsm(MethodHandles.Lookup lookup, String name, MethodType methodType, Object arg) {
    ...
    public static void main(String[] args) throws Throwable {
        TryInvokeDynamic indyMaker = new TryInvokeDynamic();
        // indyMaker.makeClassWithInvokeDynamic(nameOfCallSite, desc, bsmClass,
        // bsmName, bsmType, bsmArgs)

        indyMaker.makeClassWithInvokeDynamic("_", MethodType.methodType(BigDecimal.class), TryInvokeDynamic.class,
                "bsm", MethodType.methodType(CallSite.class, MethodHandles.Lookup.class, String.class,
