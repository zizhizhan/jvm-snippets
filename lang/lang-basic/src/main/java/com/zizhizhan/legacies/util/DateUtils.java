...
public abstract class DateUtils {
    ...
    public final static DateFormat[] formats = {rfc1123Format, oldCookieFormat, rfc1036Format,
            asctimeFormat};

    public static Date tryThese(String args) {
        return tryThese(formats, args);
    }

    public static Date tryThese(DateFormat[] dfs, String args) {
