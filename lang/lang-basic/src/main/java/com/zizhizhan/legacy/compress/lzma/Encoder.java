package com.zizhizhan.legacy.compress.lzma;

import com.zizhizhan.legacy.compress.ICodeProgress;
import com.zizhizhan.legacy.compress.lz.BinTree;
import com.zizhizhan.legacy.compress.rangecoder.BitTreeEncoder;
...
public class Encoder {
    ...
    class LiteralEncoder {
        class Encoder2 {
            ...
            public void Init() {
                com.zizhizhan.legacy.compress.rangecoder.Encoder.InitBitModels(m_Encoders);
            }

            public void Encode(com.zizhizhan.legacy.compress.rangecoder.Encoder rangeEncoder, byte symbol)
                    throws IOException {
                int context = 1;
                for (int i = 7; i >= 0; i--) {
                    int bit = ((symbol >> i) & 1);
            ...
            public void EncodeMatched(com.zizhizhan.legacy.compress.rangecoder.Encoder rangeEncoder, byte matchByte,
            ...
            public int GetPrice(boolean matchMode, byte matchByte, byte symbol) {
                ...
                if (matchMode) {
                    for (; i >= 0; i--) {
                        int matchBit = (matchByte >> i) & 1;
                        int bit = (symbol >> i) & 1;
                        price += com.zizhizhan.legacy.compress.rangecoder.Encoder.GetPrice(
                ...
                for (; i >= 0; i--) {
                    int bit = (symbol >> i) & 1;
                    price += com.zizhizhan.legacy.compress.rangecoder.Encoder.GetPrice(m_Encoders[context], bit);
                    context = (context << 1) | bit;
                }
                return price;
            }
    ...
    class LenEncoder {
        ...
        public void Init(int numPosStates) {
            com.zizhizhan.legacy.compress.rangecoder.Encoder.InitBitModels(_choice);
        ...
        public void Encode(com.zizhizhan.legacy.compress.rangecoder.Encoder rangeEncoder, int symbol, int posState)
                throws IOException {
        ...
        public void SetPrices(int posState, int numSymbols, int[] prices, int st) {
            int a0 = com.zizhizhan.legacy.compress.rangecoder.Encoder.GetPrice0(_choice[0]);
            int a1 = com.zizhizhan.legacy.compress.rangecoder.Encoder.GetPrice1(_choice[0]);
            int b0 = a1 + com.zizhizhan.legacy.compress.rangecoder.Encoder.GetPrice0(_choice[1]);
            int b1 = a1 + com.zizhizhan.legacy.compress.rangecoder.Encoder.GetPrice1(_choice[1]);
            int i = 0;
    ...
    com.zizhizhan.legacy.compress.rangecoder.Encoder _rangeEncoder = new com.zizhizhan.legacy.compress.rangecoder.Encoder();
    ...
    void Init() {
        ...
        com.zizhizhan.legacy.compress.rangecoder.Encoder.InitBitModels(_isMatch);
        com.zizhizhan.legacy.compress.rangecoder.Encoder.InitBitModels(_isRep0Long);
        com.zizhizhan.legacy.compress.rangecoder.Encoder.InitBitModels(_isRep);
        com.zizhizhan.legacy.compress.rangecoder.Encoder.InitBitModels(_isRepG0);
        com.zizhizhan.legacy.compress.rangecoder.Encoder.InitBitModels(_isRepG1);
        com.zizhizhan.legacy.compress.rangecoder.Encoder.InitBitModels(_isRepG2);
        com.zizhizhan.legacy.compress.rangecoder.Encoder.InitBitModels(_posEncoders);
    ...
    int GetRepLen1Price(int state, int posState) {
        return com.zizhizhan.legacy.compress.rangecoder.Encoder.GetPrice0(_isRepG0[state])
                + com.zizhizhan.legacy.compress.rangecoder.Encoder.GetPrice0(
    ...
    int GetPureRepPrice(int repIndex, int state, int posState) {
        int price;
        if (repIndex == 0) {
            price = com.zizhizhan.legacy.compress.rangecoder.Encoder.GetPrice0(_isRepG0[state]);
            price += com.zizhizhan.legacy.compress.rangecoder.Encoder.GetPrice1(
                    _isRep0Long[(state << Base.kNumPosStatesBitsMax) + posState]);
        } else {
            price = com.zizhizhan.legacy.compress.rangecoder.Encoder.GetPrice1(_isRepG0[state]);
            if (repIndex == 1)
                price += com.zizhizhan.legacy.compress.rangecoder.Encoder.GetPrice0(_isRepG1[state]);
            else {
                price += com.zizhizhan.legacy.compress.rangecoder.Encoder.GetPrice1(_isRepG1[state]);
                price += com.zizhizhan.legacy.compress.rangecoder.Encoder.GetPrice(_isRepG2[state], repIndex - 2);
            }
        }
        return price;
    }
    ...
    int GetOptimum(int position) throws IOException {
        ...
        _optimum[1].Price = com.zizhizhan.legacy.compress.rangecoder.Encoder
        ...
        int matchPrice = com.zizhizhan.legacy.compress.rangecoder.Encoder
                .GetPrice1(_isMatch[(_state << Base.kNumPosStatesBitsMax) + posState]);
        int repMatchPrice = matchPrice + com.zizhizhan.legacy.compress.rangecoder.Encoder.GetPrice1(_isRep[_state]);
        ...
        int normalMatchPrice = matchPrice + com.zizhizhan.legacy.compress.rangecoder.Encoder.GetPrice0(_isRep[_state]);
        ...
        while (true) {
            ...
            int curAnd1Price = curPrice
                    + com.zizhizhan.legacy.compress.rangecoder.Encoder
            ...
            repMatchPrice = matchPrice + com.zizhizhan.legacy.compress.rangecoder.Encoder.GetPrice1(_isRep[state]);
            ...
            if (!nextIsChar && matchByte != currentByte) {
                ...
                if (lenTest2 >= 2) {
                    ...
                    int nextRepMatchPrice = curAnd1Price
                            ...
                            + com.zizhizhan.legacy.compress.rangecoder.Encoder.GetPrice1(_isRep[state2]);
                    {
            ...
            if (newLen >= startLen) {
                normalMatchPrice = matchPrice + com.zizhizhan.legacy.compress.rangecoder.Encoder.GetPrice0(_isRep[state]);
    ...
    void FillDistancesPrices() {
        ...
        for (int lenToPosState = 0; lenToPosState < Base.kNumLenToPosStates; lenToPosState++) {
            ...
            for (posSlot = Base.kEndPosModelIndex; posSlot < _distTableSize; posSlot++)
                _posSlotPrices[st + posSlot] += ((((posSlot >> 1) - 1) - Base.kNumAlignBits) << com.zizhizhan.legacy.compress.rangecoder.Encoder.kNumBitPriceShiftBits);
