...
public class HttpsClient {
    ...
    public static void main(String[] args) throws Exception {
        ...
        request.setRequestProperty("User-Agent", "HttpsClient/1.0");
    ...
    private static void initializeSetting(URLConnection request, String requestType, String content, String typeStr,
                                          String msTimeout) {
